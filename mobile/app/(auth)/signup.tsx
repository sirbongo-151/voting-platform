...
export default function Signup() {
  ...
  resizeMode="contain" />
          ...
          <Forms
                ...
                <CustomButton title="Signup" handleOnPress={() => {}} backgroundColor="orange-500" textColor="white"/>
                <Text className='text-white text-center mt-5'>Already have an account? <Link href="./login" className="text-lg text-orange-500  p-2 rounded-lg">Log In</Link></Text>    
         </View>
        </KeyboardAvoidingView>
      </ScrollView>
    </SafeAreaView>
